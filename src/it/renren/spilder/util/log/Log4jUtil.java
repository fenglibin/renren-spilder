 ...
 * @version: 1.0.0 2010-5-5 下午08:32:26
 * 类说明:  
 */
...
public class Log4jUtil {
	...
	public static void setup(String logFileName, String logLevel,
			String datePattern, String appender, String layout,
		...
		try {
			...
			PropertyManager pmLog4j = PropertyManager.getInstance(pf
					.getAbsolutePath());
			...
			pmLog4j
					.setProperty("log4j.appender.bimis.DatePattern",
							datePattern);
			...
			pf = new File(path + "log" + File.separator + "err"
					+ File.separator + logFileName);
			pmLog4j.setProperty("log4j.appender.bimis.File", pf
					.getAbsolutePath());
			pmLog4j.setProperty("log4j.appender.bimis.layout", layout);
			pmLog4j.setProperty(
					"log4j.appender.bimis.layout.ConversionPattern",
					ConversionPattern);
