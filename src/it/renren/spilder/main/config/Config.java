...
public class Config {
    ...
    public static ParentPage initParentPage(Document ruleXml) throws JDOMException, EvalError {
        ...
        parentPageConfig.getUrlListPages().setValues(
                                                     (Element) (XPath.selectSingleNode(ruleXml, "/Rules/MainUrl/Values")));
        parentPageConfig.setSaveImage(JDomUtil.getValueByXpath(ruleXml, "/Rules/MainUrl/ImageDescUrl/IsSaveImage") == null ? true : Boolean.parseBoolean(JDomUtil.getValueByXpath(
                                                                                                                                                                                  ruleXml,
                                                                                                                                                                                  "/Rules/MainUrl/ImageDescUrl/IsSaveImage")));
        parentPageConfig.setOnlyImage(JDomUtil.getValueByXpath(ruleXml, "/Rules/MainUrl/ImageDescUrl/OnlyImage") == null ? false : Boolean.parseBoolean(JDomUtil.getValueByXpath(
                                                                                                                                                                                 ruleXml,
        ...
        parentPageConfig.setRandRecommandFrequency(Integer.parseInt(JDomUtil.getValueByXpath(ruleXml,
                                                                                             "/Rules/MainUrl/Recommend/Value").equals(
                                                                                                                                      "") ? "0" : JDomUtil.getValueByXpath(
                                                                                                                                                                           ruleXml,
                                                                                                                                                                           "/Rules/MainUrl/Recommend/Value")));
        parentPageConfig.setSRcommand(JDomUtil.getValueByXpath(ruleXml, "/Rules/MainUrl/SRecommend/Value") == null ? false : Boolean.parseBoolean(JDomUtil.getValueByXpath(
                                                                                                                                                                           ruleXml,
                                                                                                                                                                           "/Rules/MainUrl/SRecommend/Value")));
        parentPageConfig.setFilterDownloadUrl(JDomUtil.getValueByXpath(ruleXml,
                                                                       "/Rules/MainUrl/FilterDownloadUrl/Value") == null ? true : Boolean.parseBoolean(JDomUtil.getValueByXpath(
                                                                                                                                                                                ruleXml,
        ...
        parentPageConfig.getUrlFilter().setCompByRegex(
                                                       JDomUtil.getValueByXpath(ruleXml,
                                                                                "/Rules/MainUrl/UrlFilter/IsCompByRegex/Value") == null ? false : Boolean.parseBoolean(JDomUtil.getValueByXpath(
                                                                                                                                                                                                ruleXml,
        ...
        parentPageConfig.setAutoDetectTypeMapClass(JDomUtil.getValueByXpath(ruleXml,
                                                                            "/Rules/MainUrl/AutoDetect/TypeMapMakeClass") == null ? "" : JDomUtil.getValueByXpath(
                                                                                                                                                                  ruleXml,
                                                                                                                                                                  "/Rules/MainUrl/AutoDetect/TypeMapMakeClass"));
        parentPageConfig.setOneUrlSleepTime(JDomUtil.getValueByXpath(ruleXml, "/Rules/MainUrl/OneUrlSleepTime/Value") == null ? 0 : Long.parseLong(JDomUtil.getValueByXpath(
                                                                                                                                                                            ruleXml,
                                                                                                                                                                            "/Rules/MainUrl/OneUrlSleepTime/Value")));
        parentPageConfig.getTranslater().setFrom(
                                                 JDomUtil.getValueByXpath(ruleXml,
                                                                          "/Rules/MainUrl/Translater/From/Value") == null ? "" : JDomUtil.getValueByXpath(
                                                                                                                                                          ruleXml,
        ...
        parentPageConfig.setBlogType(Integer.parseInt(JDomUtil.getValueByXpath(ruleXml,
                                                                               "/Rules/MainUrl/BlogType/TypeId") == null ? "0" : JDomUtil.getValueByXpath(
                                                                                                                                                          ruleXml,
    ...
    public static ChildPage initChildPage(Document ruleXml) throws JDOMException {
        ...
        childPageConfig.getTitle().setIssRegularExpression(
        ...
        childPageConfig.getContent().setMinLength(
                                                  Integer.parseInt(JDomUtil.getValueByXpath(ruleXml,
                                                                                            "/Rules/Child/Content/MinLength") == null ? String.valueOf(it.renren.spilder.main.Constants.CONTENT_LEAST_LENGTH) : JDomUtil.getValueByXpath(
                                                                                                                                                                                                                                         ruleXml,
        ...
        childPageConfig.getContent().setIssRegularExpression(
                                                             Boolean.parseBoolean(JDomUtil.getValueByXpath(ruleXml,
        ...
        childPageConfig.getContent().setWashContent(
                                                    JDomUtil.getValueByXpath(ruleXml,
                                                                             "/Rules/Child/Content/WashContent/Value") == null ? "" : JDomUtil.getValueByXpath(
                                                                                                                                                               ruleXml,
                                                                                                                                                               "/Rules/Child/Content/WashContent/Value"));
        childPageConfig.getContent().setHandler(
                                                JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Handler/Value") == null ? "" : JDomUtil.getValueByXpath(
                                                                                                                                                                ruleXml,
                                                                                                                                                                "/Rules/Child/Content/Handler/Value"));

        childPageConfig.getContent().setSeparatePageMaxPages(
                                                             Integer.parseInt(JDomUtil.getValueByXpath(ruleXml,
                                                                                                       "/Rules/Child/Content/SeparatePage/MaxPages") == null ? Constants.SeparatePageMaxPages : JDomUtil.getValueByXpath(
                                                                                                                                                                                                                         ruleXml,
                                                                                                                                                                                                                         "/Rules/Child/Content/SeparatePage/MaxPages")));
        childPageConfig.getContent().setSeparatePageUrlSuffix(
                                                              JDomUtil.getValueByXpath(ruleXml,
                                                                                       "/Rules/Child/Content/SeparatePage/UrlSuffix") == null ? "" : JDomUtil.getValueByXpath(
                                                                                                                                                                              ruleXml,
        ...
        if (JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/Start/Value") != null) {
            childPageConfig.getReplys().setStart(
                                                 StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml,
                                                                                                       "/Rules/Child/Content/Replys/Start/Value")));
            childPageConfig.getReplys().setEnd(
                                               StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml,
                                                                                                     "/Rules/Child/Content/Replys/End/Value")));
            childPageConfig.getReplys().setFirstMainContent(
                                                            StringUtil.returnFalseIfNull(JDomUtil.getValueByXpath(
                                                                                                                  ruleXml,
                                                                                                                  "/Rules/Child/Content/Replys/IsFirstMainContent/Value")));
            childPageConfig.getReplys().setIssRegularExpression(
                                                                StringUtil.returnFalseIfNull(JDomUtil.getValueByXpath(
                                                                                                                      ruleXml,
                                                                                                                      "/Rules/Child/Content/Replys/Replace/IsRegularExpression/Value")));
            childPageConfig.getReplys().setFrom(
                                                StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml,
                                                                                                      "/Rules/Child/Content/Replys/Replace/From/Value")));
            childPageConfig.getReplys().setTo(
                                              StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml,
                                                                                                    "/Rules/Child/Content/Replys/Replace/To/Value")));
            childPageConfig.getReplys().getReply().setStart(
                                                            StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(
                                                                                                                  ruleXml,
                                                                                                                  "/Rules/Child/Content/Replys/Reply/Start/Value")));
            childPageConfig.getReplys().getReply().setEnd(
                                                          StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(
                                                                                                                ruleXml,
                                                                                                                "/Rules/Child/Content/Replys/Reply/End/Value")));
            childPageConfig.getReplys().getReply().setIssRegularExpression(
                                                                           StringUtil.returnFalseIfNull(JDomUtil.getValueByXpath(
                                                                                                                                 ruleXml,
                                                                                                                                 "/Rules/Child/Content/Replys/Reply/Replace/IsRegularExpression/Value")));
            childPageConfig.getReplys().getReply().setFrom(
                                                           StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(
                                                                                                                 ruleXml,
                                                                                                                 "/Rules/Child/Content/Replys/Replace/Reply/From/Value")));
            childPageConfig.getReplys().getReply().setTo(
                                                         StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml,
                                                                                                               "/Rules/Child/Content/Replys/Reply/Replace/To/Value")));
        }
        childPageConfig.setAddUrl(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/AddUrl/Value") == null ? false : Boolean.parseBoolean(JDomUtil.getValueByXpath(
                                                                                                                                                                 ruleXml,
                                                                                                                                                                 "/Rules/Child/AddUrl/Value")));
        childPageConfig.setAddUrlDisplayString(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/AddUrl/Display") == null ? "" : JDomUtil.getValueByXpath(
                                                                                                                                                        ruleXml,
                                                                                                                                                        "/Rules/Child/AddUrl/Display"));
        childPageConfig.setKeepFileName(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/KeepFileName/Value") == null ? false : Boolean.parseBoolean(JDomUtil.getValueByXpath(
                                                                                                                                                                             ruleXml,
