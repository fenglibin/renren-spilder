...
public class AutoDetectTypes {
	...
	public static void init(ParentPage parentPageConfig){
		TypesMap types;
		try {
			types = (TypesMap)Class.forName(parentPageConfig.getAutoDetectTypeMapClass()).newInstance();
	 ...
	 * @return
	 */
	public static int detectType(ParentPage parentPageConfig,ChildPageDetail detail){
		int type = -1;
		if(typesMap == null){
