 ...
 * @version: 1.0.0 2010-5-6 上午11:58:45 类说明:
 */
...
public class LogManager {
    ...
    public static void setRepositorySelector(RepositorySelector selector, Object guard) throws IllegalArgumentException {
        if (LogManager.guard != null && LogManager.guard != guard) throw new IllegalArgumentException(
    ...
    static {
        ...
        if (override == null || "false".equalsIgnoreCase(override)) {
            ...
            if (configurationOptionStr == null) {
                ...
                if (url == null) url = Loader.getResource("log4j.properties");
            } else {
                try {
