 ...
 * </p>
 * <p>
 * Copyright: Copyright (c) 2004 Sunline.
 * </p>
 * <p>
...
public class SqlTypes {
    ...
    /**
     * Returns the SQL type from the specified Java type. Returns <tt>OTHER</tt> if the Java type has no suitable SQL
     * type mapping. The argument <tt>sqlType</tt> must be the return value from a previous call to
    ...
    public static int getSQLType(Class javaType) {
        for (int i = 0; i < _typeInfos.length; ++i) {
            ...
            if (_typeInfos[i].javaType.isAssignableFrom(javaType)) return _typeInfos[i].sqlType;
        }
    ...
    static {
        ...
        _typeConvertors.put("file", new SQLTypeConvertor() {
            ...
            public Object convert(String obj, String param) {
                if (null == obj || "".equals(obj)) return new ByteArrayInputStream(new byte[0]);
                try {
     ...
     */
    static TypeInfo[] _typeInfos = new TypeInfo[] { new TypeInfo(java.sql.Types.BIT, "bit", java.lang.Boolean.class),
