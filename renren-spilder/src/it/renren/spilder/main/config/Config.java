...
public class Config {
    ...
    public static ParentPage initParentPage(Document ruleXml) throws JDOMException, EvalError, InstantiationException, IllegalAccessException, ClassNotFoundException {
        ...
        parentPageConfig.setOnlyImage(JDomUtil.getValueByXpath(ruleXml, "/Rules/MainUrl/ImageDescUrl/OnlyImage") == null ? false : Boolean.parseBoolean(JDomUtil.getValueByXpath(ruleXml,
                                                                                                                                                                                 "/Rules/MainUrl/ImageDescUrl/OnlyImage")));
        ...
        parentPageConfig.setFilterDownloadUrl(JDomUtil.getValueByXpath(ruleXml, "/Rules/MainUrl/FilterDownloadUrl/Value") == null ? true : Boolean.parseBoolean(JDomUtil.getValueByXpath(ruleXml,
        ...
        parentPageConfig.getTranslater().setFrom(JDomUtil.getValueByXpath(ruleXml, "/Rules/MainUrl/Translater/From/Value") == null ? "" : JDomUtil.getValueByXpath(ruleXml,
        ...
        parentPageConfig.setBlogType(Integer.parseInt(JDomUtil.getValueByXpath(ruleXml, "/Rules/MainUrl/BlogType/TypeId") == null ? "0" : JDomUtil.getValueByXpath(ruleXml,
    ...
    public static ChildPage initChildPage(Document ruleXml) throws JDOMException {
        ...
        childPageConfig.getContent().setMinLength(Integer.parseInt(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/MinLength") == null ? String.valueOf(it.renren.spilder.main.Constants.CONTENT_LEAST_LENGTH) : JDomUtil.getValueByXpath(ruleXml,
        ...
        childPageConfig.getContent().setWashContent(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/WashContent/Value") == null ? "" : JDomUtil.getValueByXpath(ruleXml,
        ...
        childPageConfig.getContent().setSeparatePageMaxPages(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/SeparatePage/MaxPages") == null ? Constants.DEFAULT_SEPERATE_PAGE : Integer.parseInt(JDomUtil.getValueByXpath(ruleXml,
                                                                                                                                                                                                                                   "/Rules/Child/Content/SeparatePage/MaxPages")));
        childPageConfig.getContent().setSeparatePageUrlSuffix(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/SeparatePage/UrlSuffix") == null ? "" : JDomUtil.getValueByXpath(ruleXml,
                                                                                                                                                                                       "/Rules/Child/Content/SeparatePage/UrlSuffix"));
        childPageConfig.getContent().setSeparatePageClass(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/SeparatePage/SeparatePageClass") == null ? "it.renren.spilder.filter.seperatepage.UnderLineSeparatePage" : JDomUtil.getValueByXpath(ruleXml,
        ...
        if (JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/Start/Value") != null) {
            childPageConfig.getReplys().setStart(StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/Start/Value")));
            childPageConfig.getReplys().setEnd(StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/End/Value")));
            childPageConfig.getReplys().setFirstMainContent(StringUtil.returnFalseIfNull(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/IsFirstMainContent/Value")));
            childPageConfig.getReplys().setIssRegularExpression(StringUtil.returnFalseIfNull(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/Replace/IsRegularExpression/Value")));
            childPageConfig.getReplys().setFrom(StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/Replace/From/Value")));
            childPageConfig.getReplys().setTo(StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/Replace/To/Value")));
            childPageConfig.getReplys().getReply().setStart(StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/Reply/Start/Value")));
            childPageConfig.getReplys().getReply().setEnd(StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/Reply/End/Value")));
            ...
            childPageConfig.getReplys().getReply().setFrom(StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/Replace/Reply/From/Value")));
            childPageConfig.getReplys().getReply().setTo(StringUtil.returnBlankIfNull(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/Content/Replys/Reply/Replace/To/Value")));
        }
        ...
        childPageConfig.setAddUrlDisplayString(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/AddUrl/Display") == null ? "" : JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/AddUrl/Display"));
        ...
        childPageConfig.setExpandUrl(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/ExpandUrl/Value") == null ? true : Boolean.parseBoolean(JDomUtil.getValueByXpath(ruleXml,
                                                                                                                                                                      "/Rules/Child/ExpandUrl/Value")));
        childPageConfig.setNeedToCheckUrlIsAlreadyOperate(JDomUtil.getValueByXpath(ruleXml, "/Rules/Child/NeedToCheckUrlIsAlreadyOperate/Value") == null ? true : Boolean.parseBoolean(JDomUtil.getValueByXpath(ruleXml,
                                                                                                                                                                                                                "/Rules/Child/NeedToCheckUrlIsAlreadyOperate/Value")));
